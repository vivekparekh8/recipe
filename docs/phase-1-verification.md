...
| Full integration | Capture, adapters, storage, publishing, GitHub resolution, replay, attribution, schema, verification, safe hooks, and packed installation remain compatible. | `npm test`: 47 passed, 0 failed. |
